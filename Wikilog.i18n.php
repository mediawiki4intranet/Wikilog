...
* <span class="plainlinks">[{{fullurl:{{FULLPAGENAME}}|action=edit}} Создать этот викилог].</span>',
	...
	'wikilog-new-item-too-long' => 'Название статьи викилога слишком длинно!',
...
Комментарий появится только после его рассмотрения модератором.',
	...
	'wikilog-subscription-subscribe' => '<hr />Вы не подписаны на новые записи блога $1 по e-mail. Чтобы подписаться, кликните вкладку "следить".',
	'wikilog-subscription-unsubscribe' => '<hr />Вы подписаны по e-mail на новые записи блога $1. Чтобы отменить подписку, кликните вкладку "не следить".',
	'wikilog-subscription-subscribe-email' => '<hr />Вы не подписаны на новые записи блога $1 по e-mail. <a href="$2">Подписаться</a>.',
