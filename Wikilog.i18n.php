...
The comment will only appear after it is reviewed by a moderator.',
	...
	'wikilog-subscription-subscribe' => 'You are not subscribed to blog $1 via email yet. To subscribe click "watch" at main page of blog.',
	'wikilog-subscription-unsubscribe' => 'You are already subscribed to blog $1 via email. To cancel subscribe click "unwatch" at main page of blog.',
...
Комментарий появится только после его рассмотрения модератором.',
	...
	'wikilog-subscription-subscribe' => 'Вы не подписаны на новые записи блога $1 по e-mail. Чтобы подписаться, кликните вкладку "следить" на главной странице блога.',
	'wikilog-subscription-unsubscribe' => 'Вы подписаны по e-mail на новые записи блога $1. Чтобы отменить подписку, кликните вкладку "не следить" на главной странице блога..',
